<template>
  <section id='foot_guide'>
    ...
    <section @click = "gotoAddress({path: '/order', query: {geohash}})" class="guide_item">
      <icon name="emerhelp" :scale="20" width="40">
      </icon>
      <span>紧急救援</span>
    </section>
    <section @click = "gotoAddress({path: '/search/' + geohash})" class="guide_item">
      <icon name="illegal" :scale="20" width="40">
      </icon>
      <span>违章查询</span>
    </section>
    <section @click = "gotoAddress('/msite')" class="guide_item">
      <icon name="mall" :scale="20" width="40">
      </icon>
      <span>附近商家</span>
    </section>
    <section @click = "gotoAddress('/custself')" class="guide_item">
      <icon name="aboutus" :scale="20" width="40">
      </icon>
      <span>关于我们</span>
    </section>
    <section @click = "gotoAddress('/profile')" class="guide_item">
      <icon name="myself" :scale="20" width="40">
      </icon>
      <span>我的</span>
    </section>
  </section>
