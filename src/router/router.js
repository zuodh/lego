...
const custself = r => require.ensure([], () => r(require('../page/system/cust_self')), 'custself')
const specialmall = r => require.ensure([], () => r(require('../page/product/specialmall')), 'specialmall')
